      ...
      <section>
        ...
        <article>
          ...
          <ol style="font-size:1vw;" type="A">
            <li style="font-size:2vw;"> Meta Data Example: <a href="childPages/Meta Data.html" target="_blank">Click Here</a>
            <li style="font-size:3vw;"> Footer Blockquote Example: <a href="childPages/Footer Blockquote.html" target="_blank">Click Here</a>
            <li style="font-size:1.25vw;"> Template Exemplar: <a href="childPages/childTemplate.html" target="_blank">Click Here</a>
            <li style="font-size:1vw;"> Headings adn Paragraph Tags: <a href="childPages/Headings and Paragraph.html" target="_blank">Click Here</a>
            <li > Subscript and Superscript Tags <a href="childPages/Subscript and Superscript.html" target="_blank">Click Here</a>
            <li > Image Lesson <a href="childPages/Image Lesson.html" target="_blank">Click Here</a>
            <li style="font-size:1vw;"> Laying out DIVs (Using HTML BoilerPalte) <a href="childPages/Laying out DIVs.html" target="_blank">Click Here</a>
            <li style="font-size:1vw;"> What this index page might look like with Flexbox <a href="childPages/Flexbox.html" target="_blank">Click Here</a>
          </ol>
